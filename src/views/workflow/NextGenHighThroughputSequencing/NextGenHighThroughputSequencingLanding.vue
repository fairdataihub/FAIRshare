<template>
  <div class="flex h-full w-full max-w-screen-xl flex-col items-center justify-center p-3 px-5">
    <div class="flex h-full w-full flex-col">
      ...
      <span> Let's make your Next Gen Sequencing Data FAIR </span>
...
export default {
  name: "NextGenHighThroughputSequencingLanding",
  data() {
    return {
  ...
  methods: {
    navigateToSelectFolder() {
      this.$router.push({
        path: `/datasets/${this.datasetID}/${this.workflowID}/NextGenHighThroughputSequencing/selectFolder`,
      });
    },
    openWebsite(url) {
