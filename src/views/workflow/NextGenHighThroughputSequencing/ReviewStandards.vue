...
export default {
  name: "NextGenHighThroughputSequencingReviewStandards",
  data() {
    return {
  ...
  methods: {
    ...
    async goBack() {
      ...
      if ("source" in this.workflow) {
        if (this.workflow.source.type === "local") {
          routerPath = `/datasets/${this.datasetID}/${this.workflowID}/NextGenHighThroughputSequencing/selectFolder`;
        } else if (this.workflow.source.type === "github") {
          routerPath = `/datasets/${this.datasetID}/${this.workflowID}/NextGenHighThroughputSequencing/selectGithubRepo`;
        }
      }
    ...
    startCuration() {
      this.dataset.data.NextGenHighThroughputSequencing.standards = this.questions;

      this.datasetStore.updateCurrentDataset(this.dataset);
      this.datasetStore.syncDatasets();

      this.$router.push(
        `/datasets/${this.datasetID}/${this.workflowID}/NextGenHighThroughputSequencing/createMetadata`
      );
    },
  },
  async mounted() {
    ...
    if ("standards" in this.dataset.data.NextGenHighThroughputSequencing) {
      this.questions = this.dataset.data.NextGenHighThroughputSequencing.standards;
    }
  },
};
</script>
