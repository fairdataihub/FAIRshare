...
export default {
  ...
  methods: {
    ...
    async goBack() {
      ...
      if ("source" in this.workflow) {
        if (this.workflow.source.type === "local") {
          routerPath = `/datasets/${this.datasetID}/${this.workflowID}/Other/selectFolder`;
        } else if (this.workflow.source.type === "github") {
          routerPath = `/datasets/${this.datasetID}/${this.workflowID}/Other/selectGithubRepo`;
        }
      }
    ...
    startCuration() {
      this.dataset.data.Other.standards = this.questions;

      this.datasetStore.updateCurrentDataset(this.dataset);
      this.datasetStore.syncDatasets();

      this.$router.push(`/datasets/${this.datasetID}/${this.workflowID}/Other/createMetadata`);
    },
  },
  async mounted() {
    ...
    if ("standards" in this.dataset.data.Other) {
      this.questions = this.dataset.data.Other.standards;
    }
  },
};
</script>
