                      ...
                      <el-form-item label="Unique identifier">
                        ...
                        <div v-if="greyOutIdentifierInput" class="flex pt-2">
                          <p class="pr-1 text-sm text-gray-500">
                            An identifier will be automatically assigned to this dataset when files
                            are uploaded from your system.
                          </p>
                          <p class="text-url cursor-pointer !text-sm" @click="editUniqueIdentifier">
                          ...
                          <div class="flex w-full flex-row items-center">
                            ...
                            <div class="flex-row">
                              <el-tag
                                ...
                                :type="step3Form.applicationCategory === 'Scientific' ? '' : 'info'"
                              >
                                Scientific
                              </el-tag>
                            </div>
                        ...
                        <div class="flex w-full flex-row items-center">
                          ...
                          <div class="flex-row">
                            ...
                            <el-tag
                              ...
                              size="small"
                              @click="
                                step3Form.funding.organization = 'National Science Foundation (NSF)'
                              "
                              :type="
                                step3Form.funding.organization ===
...
export default {
  ...
  methods: {
    ...
    navigateToStep6FromStep5() {
      if (this.step5Form.programmingLanguage.length <= 0) {
        this.$message({
          message: "Please add at least one programming language.",
          type: "error",
        });
        return;
      }
  ...
  async mounted() {
    this.$nextTick(async function () {
      ...
      if ("generateCodeMeta" in this.workflow) {
        this.generateCodeMeta = this.workflow.generateCodeMeta ? "Yes" : "No";
      } else {
        this.generateCodeMeta = "None";
      }
