<template>
  <div class="flex h-full w-full max-w-screen-lg flex-col items-center justify-center p-3 pr-5">
    <div class="flex h-full w-full flex-col">
      <h1 class="pb-1 pt-5 text-3xl font-bold text-slate-700">Contact Us</h1>
      ...
      <div class="flex h-full w-full flex-col items-center justify-start">
        <div>
          <Vue3Lottie
            animationLink="https://assets3.lottiefiles.com/packages/lf20_u25cckyh.json"
            :width="300"
            :height="300"
          />
        </div>
        <div class="flex items-center justify-center space-x-4">
          ...
          <button
            ...
            @click="openURL('https://fairdataihub.org/contact-us')"
          >
            Send us a message <el-icon><chat-dot-round /></el-icon>
          </button>
        </div>
      </div>
    </div>
