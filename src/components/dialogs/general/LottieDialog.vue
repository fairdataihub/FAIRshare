    ...
    <Dialog as="div" @close="setIsOpen(false, 'outside')">
      <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="min-h-screen px-4 text-center">
          ...
          >
            <div
              class="my-8 ml-[9rem] inline-block h-[450px] w-full max-w-lg transform flex-col justify-between overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all"
            >
              <div class="flex h-full flex-col justify-between">
                ...
                <div
                  ...
                  v-if="localShowCancelButton || showConfirmButton"
                >
                  <button
...
export default {
  ...
  props: {
    animationURL: {
      required: false,
      type: String,
      default: "https://assets4.lottiefiles.com/packages/lf20_z7llz6iq.json",
    },
    width: {
      required: false,
      type: Number,
